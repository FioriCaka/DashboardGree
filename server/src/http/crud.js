...
export const schemas = {
  ...
  client: z.object({
    ...
    clientStatus: z.string().default("active"),
  ...
  product: z.object({
    ...
    subcategoryId: optionalNullableNumber(),
    ...
    btu: optionalNullableNumber(),
    areaMm2: optionalNullableNumber(),
    energyClass: z.string().optional().nullable(),
    seer: z.string().optional().nullable(),
    scop: z.string().optional().nullable(),
    wifiEnabled: z.coerce.boolean().optional(),
    heatingCooling: z.coerce.boolean().optional(),
    series: z.string().optional().nullable(),
    warrantyYears: z.coerce.number().int().optional(),
    installationPrice: z.coerce.number().optional(),
    maintenancePrice: z.coerce.number().optional(),
  ...
  project: z.object({
    ...
    clientId: optionalNullableNumber(),
    status: optionalEnum(
      ["pending", "designing", "offer_ready", "approved", "installing", "completed"],
      "pending",
    ),
    assignedTo: optionalNullableNumber(),
    notes: z.string().optional().nullable(),
